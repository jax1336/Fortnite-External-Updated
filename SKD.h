...
inline std::string სახელი = (_xor_("Internal")); // application name. right above the blurred text aka the secret on the licenses tab among other tabs
inline std::string მესაკუთრე = (_xor_("oeGT0zv0TT")); // ownerid, found in account settings. click your profile picture on top right of dashboard and then account settings.
inline std::string საიდუმლო = (_xor_("0ef24125978b3c183c709e657e393e113ef63dde33e89093ab1b9f76fa130d27")); // app secret, the blurred text on licenses tab and other tabs
inline std::string ვერსია = (_xor_("6.0")); // leave alone unless you've changed version on website//std::string name = "urd"; // application name. right above the blurred text aka the secret on the licenses tab among other tabs
inline std::string ბმული = (_xor_("https://keyauth.win/api/1.2/")); // change if you're self-hosting
