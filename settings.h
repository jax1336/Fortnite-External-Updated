...
namespace PlayerColor {
	...
	ImVec4 BoxVisible = ImColor(0, 255, 0, 255);
	ImVec4 BoxNotVisible = ImColor(255, 0, 0, 255);
	ImVec4 targetcol = ImColor(255, 255, 0, 255);
	ImVec4 accentcolor = ImColor(255, 255, 0, 255);

	ImVec4 SkeletonVisible = ImColor(255, 255, 255, 255);
	ImVec4 SkeletonNotVisible = ImColor(255, 255, 255, 255);
	ImVec4 SnaplineVisible = ImColor(255, 255, 255, 255);
	ImVec4 SnaplineNotVisible = ImColor(255, 255, 255, 255);
	ImVec4 TopTextVisible = ImColor(0, 255, 255, 150);
	ImVec4 TopTextNotVisible = ImColor(255, 0, 0, 255);
	ImVec4 BottomTextVisible = ImColor(255, 0, 0, 255);

	ImVec4 BottomTextNotVisible = ImColor(0, 255, 0, 255);
...
inline bool always_spotted = false;
...
//Esp Design Types
inline const char* ESPDesign[] = { "Rounded Box", "Non-Rounded Box", "3D Box", "Corner ESP" };
inline int ESPStartType= 1;


//Aimbone
inline const char* AimboneText[] = { "Head", "Neck", "Body", "Penis Bone"};
inline int AimboneVar = 1;

//AimKey
inline const char* AimKeysText[] = { "Right mouse", "Left mouse", "Shift Key"};
inline int AimKeyVar = 1;
